...
import cartLady from '../assests/cart-lady.jpg'
...
const SignIn = () => {
  ...
  let handleSubmit = async (e) => {
    e.preventDefault()
    if(!email || !password) { dispatch(signInFailure('all fields are required')) }
    try {
      ...
      <div className='flex-1'>
        <div className='mb-2'>
         ...
         <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
          <input type="text" id='email' onChange={handleChange} placeholder='email' className='w-full border p-2 rounded-md outline-none'/>
          <input type="text" id='password' onChange={handleChange} placeholder='password' className='w-full border p-2 rounded-md outline-none'/>
